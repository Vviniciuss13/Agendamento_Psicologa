...
<body>
    ...
    <!--fim do calendario-->
        <div id="menu">
            <ul>
                <li><a class="fa-solid fa-bookmark" href="#"></a></li>
                <li><a class="fa-solid fa-pen-to-square" href="#"></a></li>
                <li><a class="fa-solid fa-arrow-down" href="#"></a></li>
                <li><a class="fa-solid fa-circle-check" href="#"></a></li>
            </ul>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" style="border:0 none;  box-shadow: 0 0 0 0;  outline: 0;"></button>
                </div>
                <div class="modal-body">
                    <form class="row g-3" id="add-Nota">
                        <div class="col-12">
                            <textarea cols="55" rows="10" id="nota" name="nota"></textarea>
                        </div>
                </div>
...
<!-- Inicio do Modal AgendarCliente-->
    <div class="modal fade" id="ModalAgendarCliente" tabindex="-1" role="dialog" aria-labelledby="TituloModalAgendarCliente" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row g-3" id="cad-usuario-form" method="post" action="<?= url("cadastrar/agenda/agendar") ?>">
                <div class="form-group" id="cliente"><label for="cliente">Cliente</label>
                    <select name="id_cliente" id="cliente" class="form-control">
                        <option value="">Selecione um Cliente</option>
                            ...
                            ?>
                                <option value="<?= $cliente->id_cliente ?>" id="<?= $cliente->id_cliente ?>">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-outline-success" id="adicionar-btn" value="Agendar">Agendar
                </form>
            </div>
        </div>
    </div>
    ...
    <article><!--Conteudo-->
        <div class="article-menu" style="background-color: #79B5AF;">
        <ul>
               ...
               <a class="dropdown-item" href="<?= url("listagem/agendamentos") ?>">Agendamentos</a>
               ...
               <a class="dropdown-item" href="<?= url("ajuda.php") ?>">Ajuda</a>
			   <a class="dropdown-item" href="<?= url("") ?> ">Sair</a>
               </div>
               </li>
                                <li>
                            <button type="button" id="botao_agendar" class="btn btn-default btn-sm" data-bs-toggle="modal" data-bs-target="#ModalAgendarCliente">
	        ...
	        <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <td scope="col"><?php echo utf8_encode(strftime('%A, %d de %B de %Y', strtotime(('today')))) ?></td>
    ...
    <script>
	    ...
	    document.querySelector("#data").value = hoje.toISOString().substring(0,10)
	    document.querySelector("#data").min = hoje.toISOString().substring(0,10)
</script>
</body>
</html>